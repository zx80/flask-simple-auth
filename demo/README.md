...
# /users/<uid>
curl -i -X GET    -u foo:bla               $URL/users/3  # 200
curl -i -X GET    -u zeo:zz                $URL/users/3  # 200
curl -i -X PATCH  -u foo:bla -d email=zz@d $URL/users/3  # 204
curl -i -X GET    -u zeo:zz                $URL/users/1  # 403
curl -i -X DELETE -u foo:bla               $URL/users/1  # 204
```
